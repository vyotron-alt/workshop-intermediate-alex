# Workshop Intermediate — Alex

Student workshop sandbox for Intermediate portal demos.

**Login mapping (portal):** see StudentTraining `intermediate-portal` — assessed check→skill map, floor rules, bus, style, and honesty live **only** in the portal, not in this repo.
